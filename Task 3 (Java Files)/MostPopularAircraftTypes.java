...
public class MostPopularAircraftTypes {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String outputFileName = "ct3_test_cluster_massive.txt";
       
        // load files from cluster
         String flightDataDir = "hdfs://soit-hdp-pro-1.ucc.usyd.edu.au/share/data3404/assignment/ontimeperformance_flights_massive.csv";
