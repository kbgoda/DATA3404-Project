...
public class AverageDepartureDelayUnoptimised {
	...
	public static void main(String[] args) throws Exception {
		...
		String outputFileName = "lt2_test_unoptimised_tiny.txt";
		...
		ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
		 ...
		 String flightsFilePath = "hdfs://soit-hdp-pro-1.ucc.usyd.edu.au/share/data3404/assignment/ontimeperformance_flights_large.csv";
		 String outputDir = "hdfs://soit-hdp-pro-1.ucc.usyd.edu.au/user/bmar9979/" + outputFileName;

//		String airlinesFilePath = "/home/bmar9979/Documents/data3404_files/Assignment/assignment_data_files/ontimeperformance_airlines.csv";
//		String flightsFilePath = "/home/bmar9979/Documents/data3404_files/Assignment/assignment_data_files/ontimeperformance_flights_tiny.csv";
//		String outputDir = "/home/bmar9979/data3404_testOutputFiles/task2/" + outputFileName;
		...
		DataSet<Tuple7<String, String, String, String, String, String, String>> total_combined = airlines.join(flights)
				.where(0).equalTo(0).with(new UnoptimisedJoinAirLinesFlights());
		DataSet<Tuple7<String, String, String, String, String, String, String>> UsAirlines = total_combined
				.filter(new FilterFunction<Tuple7<String, String, String, String, String, String, String>>() {
		...
		DataSet<Tuple5<String, String, String, String, String>> smaller_UsAirlines = UsAirlines
				.reduceGroup(new TransformToFiveColumnTuple());
		DataSet<Tuple2<String, String>> smaller_UsAirlines_1 = UsAirlines.reduceGroup(new TransformToTwoColumnTuple())
				.distinct();
		// DataSet<Tuple2<String, String>> usAirlines = airlines.reduceGroup(new
		// UnoptimisedUsAirlinesReducer());

		// System.out.println(usAirline.count()); // Good 322

		// get all flight delays: <airline_code, delay>
		DataSet<Tuple2<String, Double>> flightDelays = smaller_UsAirlines
				.reduceGroup(new yearAndDelayReducer(targetYear));
		...
		DataSet<Tuple3<String, String, Double>> airlineFlightDelays = smaller_UsAirlines_1.join(flightDelays).where(0)
				.equalTo(0).with(new JoinAirLinesFlights());
	...
	@SuppressWarnings("serial")
	public static class TransformToFiveColumnTuple implements
			GroupReduceFunction<Tuple7<String, String, String, String, String, String, String>, Tuple5<String, String, String, String, String>> {
		@Override
		public void reduce(Iterable<Tuple7<String, String, String, String, String, String, String>> records,
				Collector<Tuple5<String, String, String, String, String>> out) throws Exception {
			for (Tuple7<String, String, String, String, String, String, String> airline : records) {

				out.collect(new Tuple5<String, String, String, String, String>(airline.f0, airline.f3, airline.f4,
						airline.f5, airline.f6));
			}
		}
	}

	public static class TransformToTwoColumnTuple implements
			GroupReduceFunction<Tuple7<String, String, String, String, String, String, String>, Tuple2<String, String>> {
		@Override
		public void reduce(Iterable<Tuple7<String, String, String, String, String, String, String>> records,
	...
	@SuppressWarnings("serial")
	private static class UnoptimisedJoinAirLinesFlights implements
			JoinFunction<Tuple3<String, String, String>, Tuple5<String, String, String, String, String>, Tuple7<String, String, String, String, String, String, String>> {
		@Override
		public Tuple7<String, String, String, String, String, String, String> join(
				Tuple3<String, String, String> airline, Tuple5<String, String, String, String, String> flight) {
			return new Tuple7<String, String, String, String, String, String, String>(airline.f0, airline.f1,
					airline.f2, flight.f1, flight.f2, flight.f3, flight.f4);
		}
	}
