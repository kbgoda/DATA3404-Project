...
public class Top3CessModels {
	...
	public static void main(String[] args) throws Exception {
		...
		String outputFileName = "ct1_test2_large.txt";
...
//		 String.class, String.class);
		...
		DataSet<Tuple1<String>> flights = env
				.readCsvFile(
						"hdfs://soit-hdp-pro-1.ucc.usyd.edu.au/share/data3404/assignment/ontimeperformance_flights_tiny.csv")
		...
		// total_results.writeAsFormattedText(outputDir,
		// WriteMode.OVERWRITE, new TextFormatter<Tuple2<String, Integer>>(){
